    ...
    <div class="container">
        <div class="row">
            <div class="text-center">
                <h1 class="headline-blue-color" style="font-size:47px;">Simple to use</h1>
                <div style="max-width:820px;" class="mx-auto">
                    <p class="mt-4 pt-2">
                        Nullam fringilla, purus bibendum pellentesque convallis, nec odio eu euismod. Nullam fringilla, purus bibendum pellentesque convallis,                         </p>
                </div>
            </div>
        </div>
